...
SRGF_sccan = function(dp,a,b){
  #--- mimicking Laclau & Laclau results for RLD (cm cm-3)
  #--- Refer to: doi:10.1016/j.fcr.2009.09.004
  #----- a and b are shape parameters
  
  if(missing(a)){a=67.863}  #--- calibrated for Laclau&Laclau Rainfed
  if(missing(b)){b=0.990}   #--- calibrated for Laclau&Laclau Rainfed
